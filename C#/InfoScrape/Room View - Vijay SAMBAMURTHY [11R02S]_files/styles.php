 ...
 *   /blocks/gdata.250609/styles.php
 ...
 *   /blocks/sharedropbox/styles.php
...
/***** /mod/assessment/styles.php start *****/

#mod-assessment-submissions .feedback .content,
#mod-assessment-submissions .feedback .topic,
#mod-assessment-submissions .feedback .picture
{
  padding: 10px;
  border-width:1px;
  border-style:solid;
...
.mod-assessment .feedback .files {
  float: right;
  background-color: #EFEFEF;
  padding:5px;
}

.mod-assessment .feedback .grade {
  float: right;
}

.mod-assessment .feedback .from {
  float: left;
}

.mod-assessment .feedback .time {
  font-size: 0.8em;
}
...
.mod-assessment .files img {
  margin-right: 4px;
}

.mod-assessment .files a {
  white-space:nowrap;
}

#mod-assessment-submissions .generaltable .r1 {
  background-color: #FFFFFF;
}

#mod-assessment-submissions .header .commands {
  display: inline;
}

#mod-assessment-submissions .s0 {
  background: #FFD991;
}

#mod-assessment-submissions table.submissions td,
#mod-assessment-submissions table.submissions th
{
  border-width: 1px;
  border-style: solid;
  border-color: #DDDDDD;
...
#mod-assessment-submissions .submissions .grade {
  text-align: right;
  font-weight:bold;
}

#mod-assessment-submissions .picture {
  width: 35px;
}

#mod-assessment-submissions .fullname {
  text-align: left;
}

#mod-assessment-submissions .timemodified,
#mod-assessment-submissions .timemarked
{
  text-align: left;
  font-size: 0.9em;
}

#mod-assessment-submissions .status {
  text-align: center;
}

#mod-assessment-view #online .singlebutton {
  text-align: center;
}
...
#mod-assessment-view .feedback .topic {
  padding: 4px;
  border-style:solid;
  border-width: 0px;
  border-bottom-width: 1px;
...
#mod-assessment-view .feedback .fullname {
  font-weight: bold;
}

#mod-assessment-view .feedback .date {
  font-size: 0.8em;
}

#mod-assessment-view .feedback .content {
  padding: 4px;
}

#mod-assessment-view .feedback .grade {
  text-align: right;
  font-weight:bold;
}

#mod-assessment-view .feedback .left {
  width: 35px;
  padding: 4px;
  text-align: center;
  vertical-align: top;
}
/***** /mod/assessment/styles.php end *****/
...
.mod-lesson .progress_bar_completed {
    ...
    background-image: url(http://lionel.kgv.edu.hk/mod/lesson/completed.gif);
...
.mod-lesson .progress_bar_todo {
    /*  Example Use of Image
    background-image: url(http://lionel.kgv.edu.hk/mod/lesson/todo.gif);
    background-repeat: repeat-x;
    background-position: center;
    */
...
.mod-lesson .progress_bar_token {
    /*  Example Use of Image
    background-image: url(http://lionel.kgv.edu.hk/mod/lesson/token.gif);
...
/***** /blocks/gdata.250609/styles.php start *****/

.blocks-gdata .mform {
    width: 100%;
}/***** /blocks/gdata.250609/styles.php end *****/
...
/***** /blocks/sharedropbox/styles.php start *****/

.block_sharedropbox .clockTable {
    width: 100%;
}

.block_sharedropbox .clock {
    width: 98%;
    border: 0;
    font-family: monospace;
    text-align: right;
}
/***** /blocks/sharedropbox/styles.php end *****/
...
.yui-skin-sam .yui-panel .hd{padding:0 10px;font-size:93%;line-height:2;*line-height:1.9;font-weight:bold;color:#000;background:url(http://lionel.kgv.edu.hk/lib/yui/assets/skins/sam/sprite.png) repeat-x 0 -200px;}
.yui-skin-sam .container-close{border-color: #45c;position:absolute;top:5px;right:6px;width:25px;height:15px;background:url(http://lionel.kgv.edu.hk/lib/yui/assets/skins/sam/sprite.png) no-repeat 0 -300px;cursor:pointer;}
.yui-skin-sam .yui-simple-dialog .bd .yui-icon{background:url(http://lionel.kgv.edu.hk/lib/yui/assets/skins/sam/sprite.png) no-repeat 0 0;width:16px;height:16px;margin-right:10px;float:left;}
